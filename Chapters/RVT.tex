...
\os{Better to just integrate 'dooming' in the algorithm pseudo-code. }  \crjs{Referring the doom mechanic is mainly relevant for the forth chapter. I can remove it from here and address it there to keep this section shorter for the article of the unbalanced recursions.}
